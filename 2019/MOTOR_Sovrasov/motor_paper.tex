...
guarantee.
At the same time, according to (\ref{eq:step3_2}), at the infinitely high value of $r$, AGS turns into
...
\begin{figure}[ht]
  ...
  \caption{Operating characteristics of the algorithms when solving problems from the GKLS 4d classes}
\end{figure}

\begin{figure}[ht]
  \centering
  \subfloat[5d Simple]{{\includegraphics[width=.5\textwidth]{images/gklss5d.pdf}}\label{fig:s4d}}
  \subfloat[5d Hard]{{\includegraphics[width=.5\textwidth]{images/gklsh5d.pdf}}\label{fig:h4d}}
  \caption{Operating characteristics of the algorithms when solving problems from the GKLS 5d classes}
\end{figure}
