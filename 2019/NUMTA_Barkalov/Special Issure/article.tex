...
\begin{figure}[h]
	\center{\includegraphics[width=0.7\linewidth]{epsilon_reserved_solution}}
...
\begin{figure}[h]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=1.0\linewidth]{evolvent_N=2_m=4} \\ (a)}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=1.0\linewidth]{evolvent_N=2_m=5} \\ (b)}
	\end{minipage}
...
\begin{figure}[h]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{stronginC3_IA} \\ a)}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{stronginC3_IA-DL} \\ b)}
	\end{minipage}
...
\begin{figure}[h!]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Simple_59_IA} \\ a)}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Simple_59_IA-DL} \\ b)}
	\end{minipage}
	\caption{Solving a Simple problem by IA (a) and IA-DL (b) methods}
	\label{fig:examples_simple}
\end{figure}

\begin{figure}[h!]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Hard_7_IA} \\ a)}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Hard_7_IA-DL} \\ b)}
	\end{minipage}
	\caption{Solving a Hard problem by IA (a) and IA-DL (b) methods}
	\label{fig:examples_simple}
\end{figure}
...
\begin{table}[h!]
	\centering
		\begin{tabular}{ccccccccccccc}
			\hline
			& \multicolumn{2}{c}{$N=2$} & & \multicolumn{2}{c}{$N=3$} & & \multicolumn{2}{c}{$N=4$} & & \multicolumn{2}{c}{$N=5$} \\
			\cline{2-3} \cline{5-6} \cline{8-9} \cline{11-12}
			& \textit{Simple} & \textit{Hard} & & \textit{Simple} & \textit{Hard} & & \textit{Simple} & \textit{Hard} & & \textit{Simple} & \textit{Hard} \\
			\hline
			IA-DL, $r_{\nu}^{loc}=1.4$ & 316 & 766 & & 7403 & 9636 & & 44304 & 60904 & & 296357 & 763711 \\
			\hline
			IA-DL, $r_{\nu}^{loc}=2.0$ & 350 & 830 & & 8990(1) & 12020 & & 47133 & 57473 & & 360497 & 743874(1) \\
			\hline
			IA & 439 & 1074 & & 11804(1) & 20327 & & 42837 & 87310(2) & & 404660(2) & 1084990(2) \\
			\hline
		\end{tabular}
	\caption{Average number of iterations}
	\label{tab:average_number_of_iterations}
\end{table}
...
\begin{table}[h!]
	\centering
		\begin{tabular}{ccccc}
			...
			\hline
		\end{tabular}
	\caption{Average number of iterations Simple}
...
\begin{table}[h!]
	\centering
		\begin{tabular}{ccccc}
			...
			\hline
		\end{tabular}
	\caption{Average number of iterations Hard}
	\label{tab:average_number_of_iterations_hard}
\end{table}

\begin{figure}[h!]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Operating_characteristic_gklssC_3} \\ a)}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Operating_characteristic_gklshC_3} \\ b)}
	\end{minipage}
	\caption{Operational characteristics for Simple (a) and Hard (b) problems, $N=3$}
	\label{fig:operational_characteristics_N=3}
\end{figure}

\begin{figure}[h!]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Operating_characteristic_gklssC_5} \\ a)}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Operating_characteristic_gklshC_5} \\ b)}
	\end{minipage}
	\caption{Operational characteristics for Simple (a) and Hard (b) problems, $N=5$}
	\label{fig:operational_characteristics_N=5}
\end{figure}

\begin{figure}[h!]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Decision_rule_gklssC_4} \\ a)}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Decision_rule_gklshC_4} \\ b)}
	\end{minipage}
	\caption{Frequency of using various estimates of the Lipschitz constant for Simple (a) and Hard (b) problems, $N=4$}
