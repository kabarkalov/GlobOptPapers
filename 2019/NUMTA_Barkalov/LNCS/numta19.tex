...
The rules of the algorithm with two estimates of the Lipschitz constant reproduce the ones of global search algorithm completely except Rule 3 (the computation of the characteristic).
...
Six GKLS classes of 100 differentiable test functions of the dimensions $N = 3,4,5$
