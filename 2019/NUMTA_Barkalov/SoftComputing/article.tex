...
\title{Global optimization method with dual Lipschitz constant estimates for problems with non-convex constraints%\thanks{Grants or other notes
...
\begin{align}\label{epsilon_reserved_solution}
	\varphi(y_{\epsilon}) &= \nonumber \\
	&\min{\left\{\varphi(y):y \in D, g_j(y)\leq -{\epsilon}_j, 1 \leq j \leq m\right\}},
\end{align}
...
\begin{align}\label{Y_epsilon}
	Y_{\epsilon} &= \nonumber \\
	&\left\{ y \in D, \; g_j(y) \leq 0, \; 1 \leq j \leq m, \; \varphi(y) \leq \varphi(y_{\epsilon}) \right\}.
\end{align}
Fig. \ref{fig:eps_reserved_solution} illustrates the concepts introduced.

\begin{figure}%[h]
	\center{\includegraphics[width=0.6\linewidth]{epsilon_reserved_solution}}
...
\begin{figure}
	\begin{minipage}[h]{0.45\linewidth}
		\center{\includegraphics[width=1.0\linewidth]{evolvent_N=2_m=4} \\ {\footnotesize(a)}}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.45\linewidth}
		\center{\includegraphics[width=1.0\linewidth]{evolvent_N=2_m=5} \\ {\footnotesize(b)}}
	\end{minipage}
...
\\
\textbf{Theorem 1}. Assume that the following conditions are satisfied:
\begin{enumerate} 
...
\label{sec:3}
	...
	According to Theorem 1, the sequence of trial points $\{y^k\}$ will converge to a point $\bar y \in Y_\epsilon$ if the condition (\ref{theorem_inequalities}) is satisfied. So far, an appropriate choice of the parameters $r_{\nu}$ allows using the values
...
\begin{figure}[h]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{stronginC3_IA} \\ {\footnotesize(a)}}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{stronginC3_IA-DL} \\ {\footnotesize(b)}}
	\end{minipage}
...
\begin{figure}[h!]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Simple_59_IA} \\ {\footnotesize(a)}}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Simple_59_IA-DL} \\ {\footnotesize(b)}}
	\end{minipage}
...
\begin{figure}[h!]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Hard_7_IA} \\ {\footnotesize(a)}}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Hard_7_IA-DL} \\ {\footnotesize(b)}}
	\end{minipage}
...
\begin{figure}[h!]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Operating_characteristic_gklssC_3} \\ {\footnotesize(a)}}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Operating_characteristic_gklshC_3} \\ {\footnotesize(b)}}
	\end{minipage}
...
\begin{figure}[h!]
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Operating_characteristic_gklssC_5} \\ {\footnotesize(a)}}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.48\linewidth}
		\center{\includegraphics[width=\linewidth]{Operating_characteristic_gklshC_5} \\ {\footnotesize(b)}}
	\end{minipage}
