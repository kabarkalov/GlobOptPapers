...
Nonlinear global optimization of non-convex functions is traditionally considered to be one of the most
difficult problems of mathematical programming. The finding of the global minimum of
a function of several variables often appears to be more difficult than local optimization in the
thousand-dimensional space. In local optimization applying of the simplest gradient descent
method may appear to be enough, whereas in order to \textit{guarantee} find the global
