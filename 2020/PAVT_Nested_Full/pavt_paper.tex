...
This class of functions is often used for investigating global optimization algorithms \cite{Sergeyev2015,Paulavicius2014,Barkalov2018}.
...
The results of solving are presented in Table \ref{tab3}, where speedup is calculated relative to running on a single node using 4 MPI processes.
...
local variables $N=100$), the speedup increased up to 35 when using 128 processes. In the last case the speedup was calculated with respect to the use of 4 processes on one node.
