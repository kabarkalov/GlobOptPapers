...
% тут нужен наш традиционный рисунок - дерево процессов
...
convergence are given in \cite{Strongin2000,Barkalov2002,Gergel2005,Strongin2013}.


%Параллельный алгоритм - пример работы? Нужен ли?
