...
The solution of MCO problems was carried out before the stopping criterion of (\ref{eq:28}) was fulfilled, and the MCO problems were considered solved correctly if the distance of the decisons to the Pareto set did not exceed the given accuracy $\varepsilon$ from (\ref{eq:28}).
...
\bibitem{c44} Audet, C., Savard, G., Zghal, W.: Multiobjective Optimization Through a Series of Single-Objective Formulations SIAM J. Optim.,19(1). pp. 188--210 (2008)
