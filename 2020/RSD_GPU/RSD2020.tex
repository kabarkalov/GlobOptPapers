...
$^1$ \and
Ilya G. Lebedev \letter%(ORCID 0000-0002-8736-0652)
$^1$ \and 
...
%
\authorrunning{K.A. Barkalov \and I.G. Lebedev \and V.V. Toropov} % abbreviated author list (for running head)
%
...
In the experiments carried out the average time for calculating the function values was 0.01 seconds.
