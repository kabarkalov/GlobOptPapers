...
\begin{figure}[ht]
    \centering
    \subfloat[MOALR with \(q=0\)]{{\includegraphics[width=.5\textwidth]{img/fonseca_glob.pdf} }}
    \subfloat[MOALR with \(q=4\)]{{\includegraphics[width=.5\textwidth]{img/fonseca_loc.pdf} }}
...
\begin{figure}[ht]
    \centering
    \subfloat[Markin-Strongin problem]{{\includegraphics[width=.5\textwidth]{img/strongin.pdf} }}
    \subfloat[Fonseca and Fleming 3d problem]{{\includegraphics[width=.5\textwidth]{img/fonseca.pdf} }}

    \subfloat[Schaffer problem N. 2]{{\includegraphics[width=.5\textwidth]{img/schaffer2.pdf} }}
