...
\begin{enumerate}
  \item Markin-Strongin problem from \cite{markinStrongin1993}:
    ...
    \end{equation}
  \item Fonseca and Fleming problem from \cite{}:
  \begin{equation}
    \label{eq:fonseca}
    \left \{
    \begin{array}{l}
  ...
  \item Schaffer function N. 2:
    \begin{equation}
      ...
      \quad y\in [-5;10]
    \end{equation}
  \item Poloni's two objective function:
    \begin{equation}
      \left \{
      \begin{array}{l}
