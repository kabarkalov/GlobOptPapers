...
\begin{figure}[ht]
    \centering
    \subfloat[MOLF with \(q=0\)]{{\includegraphics[width=.5\textwidth]{img/fonseca_glob.pdf} }}
    \subfloat[MOLF with \(q=4\)]{{\includegraphics[width=.5\textwidth]{img/fonseca_loc.pdf} }}
