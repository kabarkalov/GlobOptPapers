...
specifying the number of constraints active at the minimizer have been added. The 
...
constraints is a relevant one since standard approach to investigating and comparing the 
global optimization algorithms is based on solving a series of test problems.
Well known generators generate the problems without constraints as a rule. For example, a 
...
\cite{Gaviano2003}.  GKLS generator has been successfully applied in the investigation of some global 
...
\item The possibility to control the number of constraints active in the optimum point.
\end{itemize}
...
controlling the number of the active constraints in this one have been added in the new version 
...
constraints in the minimizer not less than $S$, the rules are modified as follows.
\begin{enumerate}
