...
%
\title{Comparison of dimensionality reduction schemes for dervative-free global optimization
algorithms}
...
\titlerunning{Dimension reduction schemes in direct GO}
...
succesful used to build large-scale parallel algorithms \cite{stronginGergelBarkalovParGO}.
