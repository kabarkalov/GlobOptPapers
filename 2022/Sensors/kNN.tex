...
%Сысоев
Следующий эксперимент проводился для определения зависимости времени поиска $K = 50$ соседей с ростом числа сэмплов для выбранной размерности $N = 4$. Число сэмплов менялось от 200 тыс. до 1 млн. Результаты, представленные на рис.XX, показывают что соотношение между процедурой А и процедурой B остается примерно тем же, а выигрыш процедуры А у kNN-ME method составляет порядка 10 раз.
