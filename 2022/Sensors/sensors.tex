...
The time required to find K nearest neighbours on the CarEvoluation dataset is shown in Fig.~\ref{fig6a}. In this experiment, the number of evolvents used simultaneously was 7. 
\begin{figure}
\widefigure
\includegraphics[width=0.5\linewidth]{fig6a.png}
