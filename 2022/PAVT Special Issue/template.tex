...
\center
\begin{minipage}{0.45\linewidth}
\center{\includegraphics[width=0.9\linewidth]{1.eps} \\ (a)}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\center{\includegraphics[width=0.9\linewidth]{2.eps} \\ (b)}
\end{minipage}
...
\center
\begin{minipage}{0.45\linewidth}
\center{\includegraphics[width=0.9\linewidth]{3.eps} \\ (a)}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\center{\includegraphics[width=0.9\linewidth]{4.eps} \\ (b)}
\end{minipage}
...
\funding{This research was funded by RFBR, project No.\,19-37-60014 (L.E.; mathematical model), and by the Russian Science Foundation, project No.\,21-11-00204 (K.B, I.L., E.K.; parallel global optimization algorithm)}
