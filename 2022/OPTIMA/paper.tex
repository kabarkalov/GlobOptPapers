...
Like  the  previous experiments, the results are presented in Tab.~\ref{tab4_6} (series 3) and Fig.~\ref{fig4_6}.

\begin{table}
\caption{Results of the experiment with multidimensional MCO problems.}
\centering
\begin{tabular}{cccccccccc} \hline
Series& N& k& Pareto & RALR-DA & OMOPSO & SPEA2 & SMPSO & IBEA & NSGAII   \\ \hline
1& 2&	2 & 6.62 & 6.44 & 5.93 & 5.88 & 5.71 & 5.65 & 5.61 \\ 
2& 4&	2 &  5.04 & 4.71 & 4.53 & 4.45 & 4.39 & 4.39 & 4.37 \\ 
3& 2&	4 &  23.89 & 23.52 & 22.87 & 22.80 & 22.53 & 20.68 & 19.82 \\ \hline
\end{tabular}
\label{tab4_6}
\end{table}
...
\caption{Relative backlog of the HV index ($HV_{Pareto} / HV_{alg}$).}\label{fig4_6} 
\end{figure}
