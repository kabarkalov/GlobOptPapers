...
\caption{\textcolor{red}{ Relative backlog of the HV index ($HV_{Pareto} / HV_{alg}$). }}\label{fig4_6} 
\end{figure}

\textcolor{red}{Fig.~\ref{fig4_6} shows the ratio of the HV indices of the Pareto set to the HV index of a specific algorithm.}
