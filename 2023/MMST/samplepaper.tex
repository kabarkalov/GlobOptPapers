...
R(i)=
  ...
  \end{cases}
\end{equation}
        \paragraph{Case 3} For the intervals with \textbf{one non-computable and one computable point}, perform the imputation of the value for the non-computable point based on the neighbor com-putable point and apply the formula
