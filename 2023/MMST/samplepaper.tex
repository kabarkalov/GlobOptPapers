...
R(i)=
  ...
  \end{cases}
\end{equation}
        \paragraph{Case 2.}   For the intervals with \textbf{one non-computable point and one boundary point}, perform the imputation of the values for the non-computable point based on the neighbor computable point and apply the formula
