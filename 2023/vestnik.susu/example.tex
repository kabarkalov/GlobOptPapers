...
\authors{К.А.~Баркалов$^{1}$, И.Г.~Лебедев$^{1}$, Д.И.~Силенко$^{1}$}

\organizations{$^{1}$Нижегородский государственный университет им. Н.И. Лобачевского\\
...
Силенко Дмитрий Игоревич, студент, Нижегородский государственный университет им. Н.И. Лобачевского (Н.Новгород, Российская Федерация)
...
\authorsen{Konstantin Barkalov$^{1}$, Ilya Lebedev$^{1}$,  Dmitry Silenko$^{1}$}

\organizations{$^{1}$Lobachevsky State University of Nizhny Novgorod\\
...
The Hooke--Jeeves pattern search algorithm belongs to the class of zero-order methods. Its computation rules are a  combination of the investigating search (to select the direction) and search in the direction selected  \bblcite{Himmelblau72}.
