...
\title{On using the decision trees to identify the local extrema in parallel global optimization algorithms  \footnote{This study was supported by the Russian Science Foundation, project No.\,21-11-00204 .}}

\authors{Konstantin Barkalov\superscript{1},Ilya Lebedev\superscript{1}, Dmitry Silenko\superscript{1}}
\organizations{\superscript{1}Lobachevsky State University of Nizhny Novgorod, Nizhny Novgorod, Russia}
