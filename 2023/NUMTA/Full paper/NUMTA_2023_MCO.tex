...
Unfortunately, finding a decision   that provides the minimal values for all partial criteria simultaneously is possible only in exceptional cases because, as a rule, partial criteria may be contradictory, i.e. when decreasing one criterion leads to increasing the other.
