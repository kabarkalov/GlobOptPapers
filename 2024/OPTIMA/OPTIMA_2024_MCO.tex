...
\textcolor[rgb]{0,0,1}{\textit{Remark 1.} The Lipschitz constant of the objective function is assumed a priori unknown; it is adaptively estimated during the search.
...
\textcolor[rgb]{0,0,1}{Other popular approaches use machine learning for auto-configuration (tuning the hyper-parameters) of optimization algorithms (see, e.g., \cite{Bezerra2020,Lopez2016} and the references given therein)}.
...
\textcolor[rgb]{0,0,1}{The HyperVolume (HV) index corresponds to the volume of the region dominated by the Pareto set approximation and bounded by a given reference point \cite{ML_MCO_2023,Evtushenko2014}. The larger the hypervolume index, the better is the corresponding approximation.
}
