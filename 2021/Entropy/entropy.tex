...
Проиллюстрируем работу алгоритма при минимизации двух конкретных многоэкстремальных функций, которые задаются в соответствии с формулами (\ref{shekel}) и (\ref{hill}). 
%далее нужны иллюстрации
\begin{figure}[H]
\label{fig1}
\includegraphics[width=1.0\linewidth]{hill.png}
\caption{This is a figure. A caption on a single line should be centered.}
\end{figure}   

\begin{figure}[H]
\label{fig2}
\includegraphics[width=1.0\linewidth]{shekel.png}
\caption{This is a figure. A caption on a single line should be centered.}
\end{figure}   
...
\midrule													
DIRECT         & 64(99)   &  -   &  34(94)   &  -   &  20(83)    \\
GSA            & 106  & 64  & 53  & 37  & 31   \\
GSA-DT         & 49   & 45  & 43  & 38  & 35   \\
...
\toprule
                      & \textbf{0,0001} & \textbf{0,0005} & \textbf{0,001} & \textbf{0,005} & \textbf{0,01} \\
\midrule					  
DIRECT                & 66(88) &  -  &  36(69)  & -  &   20(49)  \\
GSA                   & 130             & 87              & 75             & 52             & 43            \\
GSA-DT                & 64              & 60              & 59             & 55             & 50            \\
\bottomrule
\end{tabular}
\end{specialtable}
