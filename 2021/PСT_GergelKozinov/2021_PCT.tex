...
For AMMIS, 50 global optimization problems with different sets of convolution coefficients were solved.  The accuracy of the method $\varepsilon=0.05$ and the reliability parameter $r=3.0$ from (\ref{eq:23}) were used when solving the series of problems. The results of the experiments are presented in full in Table \ref{tab:1}.
