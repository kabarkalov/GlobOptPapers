...
%Russian
Использованные тестовые задачи содержали от 2 до 4 непрерывных и от 2 до 4 дискретных параметров. 
...
%Russian
Параллельный алгоритм был применен для решения той же серии из 100 problems with 5 discrete and 4 continuous parameters.
...
Несмотря на то, что предположение липшицевости позволяет провести оценку оптимума на существенно неравномерной (т.е. более экономной по сравнению с равномерной) сетке в области поиска, масштаб решаемых задач здесь ограничен. За приемлемое время даже с использованием параллельного алгоритма можно решать задачи, в которых порядка 10 непрерывных и 10 дискретных параметров. 
