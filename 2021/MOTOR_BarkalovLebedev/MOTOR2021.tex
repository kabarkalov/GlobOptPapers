...
\begin{document}
%
\title{Global search algorithm with local tuning for solving mixed-integer global optimization problems
%with non-convex constraints 
\thanks{This study was supported by the .}}
%
...
Ilya Lebedev\orcidID{0000-0002-8736-0652}
}
%
